    ...
    return Row(
      children: [
        Expanded(
          flex: 5,
          child: TextFormField(
            controller: context.read<QuestionDetailCubit>().commentEditingController,
            keyboardType: TextInputType.text,
            style: context.textTheme.headlineSmall?.copyWith(color: context.appTheme.colorScheme.onSurface),
