...
import 'package:snack_over_vbt/feature/question_detail/viewmodel/cubit/question_detail_cubit.dart';
...
class QuestionDetailView extends StatelessWidget {
  const QuestionDetailView(
      {Key? key, required this.question, required this.user})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
        create: (context) => QuestionDetailCubit(question: question, user: user, context: context),
