...
class AppColors {
  ...
  final shadowColor = Colors.pink;
  final pinkColor = const Color(0xFFDD3DE1);
  final purpleColor = const Color(0xFF6043B2);
  final darkPink = const Color.fromARGB(255, 106, 53, 107);
  final darkPurpleColor = const Color.fromARGB(255, 69, 49, 124);
  final profileTabBackgroundColor = const Color(0xFFEFF0F7);
  final profileTabBackgroundDarkColor = const Color.fromARGB(255, 116, 116, 117);
  final marigold = const Color(0xFFFFC107);
